...
RSpec.describe "Director films index", type: :feature do
  describe "#director films show page" do
  ...
  describe "#links to director index and film index" do
  ...
  describe "#links to manipulate the data" do
  ...
  describe "#delete button fuction" do
